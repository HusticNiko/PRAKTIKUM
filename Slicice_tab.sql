...
ID_SPOROCILO INTEGER NOT NULL,
SPOROCILO TEXT NOT NULL
);

ALTER TABLE SPOROCILO
ADD CONSTRAINT PK_SPOROCILO PRIMARY KEY (ID_SPOROCILO);



CREATE TABLE UPORABNIK_SPOROCILO(
idUporabnik_Sporocilo INTEGER NOT NULL,
Uporabnik_idUporabnik INTEGER NOT NULL,
Sporocilo_idSporocilo INTEGER NOT NULL
);

ALTER TABLE UPORABNIK_SPOROCILO
ADD CONSTRAINT PK_Uporabnik_Sporocilo PRIMARY KEY (ID_UPORABNIK_SPOROCILO);

ALTER TABLE UPORABNIK_SPOROCILO
ADD CONSTRAINT TK_Uporabnik_idUporabnik_ID_ FOREIGN KEY 
(Uporabnik_idUporabnik) REFERENCES UPORABNIK(ID_UPORABNIK);

ALTER TABLE UPORABNIK_SPOROCILO
ADD CONSTRAINT TK_Sporocilo_idSporocilo_ID_ FOREIGN KEY 
(Sporocilo_idSporocilo) REFERENCES SPOROCILO(ID_SPOROCILO);