...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/seznamArtiklov">
		<html>
			<head>
				<meta charset="UTF-8" />
				<link rel="stylesheet"
			...
			<body>
				...
				<div class="container">
					<div class="row">
						<div>
							<br />
							<h3>Seznam artiklov</h3>

							<div class="well" style="width:600px;">
								<table id="t-seznam" class="table">
									<tr>
										<th id="td-fix">Naziv</th>
										<th id="td-fix">Cena(€)</th>
										<th id="td-fix">Kapaciteta(GB)</th>
										<th id="td-fix">Hitrost(MHz)</th>
										<th id="td-fix">Zaloga</th>
									...
									<xsl:for-each select="artikel">
										<tr>
											...
											<td>
												<xsl:value-of select="kapaciteta" />
											</td>
											<td>
												<xsl:value-of select="hitrost" />
											</td>
											<td>
