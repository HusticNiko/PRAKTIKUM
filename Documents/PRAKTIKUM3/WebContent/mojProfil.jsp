<!DOCTYPE html>
	...
	<div class="w3-top">
		...
		<div class="w3-right w3-hide-small" id="navbar">
			...
			<a href="mojProfil.jsp"id="underline" class="w3-bar-item w3-button">Moj profil</a>
		...
		<h4>Spremeni geslo:</h4>
			<form action="/action_page.php" target="_blank">
				<input class="w3-input w3-section w3-border" type="password"
					...
					<button class="w3-button w3-section btn-carousel" type="submit" style="margin-left:50px; margin-top: 10px !important;"> Spremeni
				</button>
			</form>
		</div>
		<!-- Page content -->
